...
public class form_resepsionis extends javax.swing.JFrame {
    ...
    public void cariDataPasien() throws SQLException{
        ...
        if ("".equals(Cari.getText())){
            ...
            try{
                ...
                Object header[]={"No RM","Nama","Tanggal Lahir","Jenis Kelamin(L/P)","Gol Darah","Pekerjaan","Alamat","Telepon"};//membuat nama kolom tabel
    ...
    public void selectDataPasien(){
        try{
            scrollpane.show();
            Object header[]={"No RM","Nama","Tanggal Lahir","Jenis Kelamin(L/P)","Gol Darah","Pekerjaan","Alamat",
                "Telepon"};//membuat nama kolom dari tabel
            DefaultTableModel data = new DefaultTableModel(null, header);
            tablePasien.setModel(data);
            Connection kon = KoneksiDatabase.getConnection();
    ...
    private void initComponents() {
        ...
        btn_periksa.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        btn_periksa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gui/add.jpg"))); // NOI18N
        ...
        btn_periksa.setMargin(new java.awt.Insets(2, 2, 2, 2));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btn_periksa, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btn_periksa, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    // Pastikan pengguna mengklik dua kali (double-click)
    if (evt.getClickCount() == 2) {
        ...
        if (row != -1) { // Pastikan ada baris yang dipilih
            ...
            String noRM = tablePasien.getValueAt(row, 0).toString(); // Kolom 0 untuk No RM
            String nama = tablePasien.getValueAt(row, 1).toString(); // Kolom 1 untuk Nama Pasien

            // Kirim data ke form_periksa
            try {
                new form_periksa(nama, noRM).setVisible(true); // Buka form_periksa dengan data pasien
            } catch (SQLException ex) {
                Logger.getLogger(form_resepsionis.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void btn_periksaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_periksaActionPerformed
        int row = tablePasien.getSelectedRow();
    if (row != -1) {
        String noRM = tablePasien.getValueAt(row, 0).toString();
        String nama = tablePasien.getValueAt(row, 1).toString();
        try {
            new form_periksa(nama, noRM).setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(form_resepsionis.class.getName()).log(Level.SEVERE, null, ex);
        }
    } else {
        JOptionPane.showMessageDialog(null, "Silahkan pilih pasien dari tabel.");
    }        // TODO add your handling code here:
